...
type ToastProps = React.ComponentPropsWithoutRef<typeof Notification>

type ToastActionElement = React.ReactElement<typeof NotificationAction>
...
export {
  ...
  type ToastActionElement as NotificationActionElement,
  type ToastProps as NotificationProps,
}
